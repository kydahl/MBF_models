...
nice_parameter_table = tibble(
  ...
  Symbol = c("$\\eta$", "$\\mu$", "$\\gamma$", "$\\gamma_H$", "$\\mu_H$", "$K_H$", "$K_L$", "$\\rho_L$", "$\\mu_L$", "$\\varphi$", "$\\beta_P$", "$\\beta_G$", "$\\beta_H$", "$\\beta_V$"),
...
if (PRCC_calc) {
  ...
  for (i in 1:(100 - 1)) {rep_params = rbind(rep_params, parameters)}
...
read_rds("./data/vary_EIP_PRCC_vals.rds") %>%
  ...
  scale_color_manual("Parameter",
                     values = rev(c(c4a("tableau.color_blind", 8),"black")),
                     breaks = rev(c("lambda_Q", "p_L", "lambda_L", "p_P", "lambda_P", "p_G", "lambda_G", "f", "dummy"))
                     values = rev(c(c4a("brewer.paired", 8),"grey")),
                     breaks = rev(c("lambda_Q", "p_L", "lambda_L", "p_P", "lambda_P", "p_G", "lambda_G", "f", "dummy"))
  )+
